#######################################################################################
# Yourname: Chutikarn Jaikong
# Your student ID: 65070053
# Your GitHub Repo: https://github.com/cheraxm/IPA2024-Final.git
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.startswith("/65070053 "):

        # extract the command
        command = message[len("/65070053 "):].strip()
        print(command)
...
# 6. Complete the code to post the message to the Webex Teams room.
        ...
        if command == "showrun" and responseMessage == 'ok':
            filename = "show_run_65070053_IPA2024_Pod1_1.txt"
            fileobject = open("show_run_65070053_IPA2024_Pod1_1.txt", "rb")
            filetype = "text/plain"
            postData = {
